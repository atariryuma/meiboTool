...
EXACT_MAP: dict[str, str] = {
    ...
    '転入前学校': '転入前学校',
    '転入前学校住所': '転入前学校住所',
    '転入前学校在籍開始日': '転入前学校在籍開始日',
    '転入前学校在籍終了日': '転入前学校在籍終了日',
    '転入日': '転入日',
    '転入事由': '転入事由',
    '編入前学校': '編入前学校',
    '編入前学校住所': '編入前学校住所',
    '編入前学校在籍開始日': '編入前学校在籍開始日',
    '編入前学校在籍終了日': '編入前学校在籍終了日',
    '編入日': '編入日',
    '編入事由': '編入事由',
    # ── C4th 保護者 ──
    ...
    'ピアノ': 'ピアノ',
    '問題行動※５つまで選択可': '問題行動種別',
    '問題行動具体例※12字以内': '問題行動具体',
    '〇一緒にしたい生徒と理由': '配慮児童',
    '×別々にしたい生徒と理由': '不適児童メモ',
    '1年引き継ぎ事項※26字以内': '引継事項1年',
    '2年引き継ぎ事項※26字以内': '引継事項2年',
    '3年引き継ぎ事項※26字以内': '引継事項3年',
    '4年引き継ぎ事項※26字以内': '引継事項4年',
    '5年引き継ぎ事項※26字以内': '引継事項5年',
    '証書番号': '証書番号',
    '進学先': '進学先',
}
...
# 公簿名 ↔ 正式氏名: .lay の FIELD_ID_MAP は「公簿名」を使い、
# C4th mapper は「正式氏名」を出力するため、相互フォールバックが必要
